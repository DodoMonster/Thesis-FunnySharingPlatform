...
require_once 'Crypt_Hash.php'; 
require_once 'Crypt_RSA.php'; 
require_once 'Crypt_TripleDES.php'; 
require_once 'Math_BigInteger.php'; 
...
//	正式环境请求基础地址
     ...
     * @return string
     */
    public function webPay($order_id, $transtime, $amount, $cardno, $idcardtype, $idcard, $owner, $product_catalog, $identity_id, $identity_type, $user_ip, $user_ua, $callbackurl = '', $fcallbackurl = '', $currency = 156, $product_name = '', $product_desc = '', $terminaltype, $terminalid, $orderexp_date = 60, $paytypes, $version,$is_pc=0) {
        $query = array(
            'orderid' => $order_id,
            'transtime' => $transtime,
            'currency' => $currency,
